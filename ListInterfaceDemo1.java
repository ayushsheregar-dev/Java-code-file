...
/**
 * Class Name: ListInterfaceDemo
 * Description: Demonstrates List operations using ArrayList and LinkedList.
 */
public class ListInterfaceDemo1 {
    public static void main(String[] args) {
        ...
        // 11. Sorting (Natural Order)
        Collections.sort(arrayList);
        System.out.println("After sorting: " + arrayList);

        // 12. Sublist (Extracting a portion)
        ...
        // Demonstrating specific Deque interface methods
